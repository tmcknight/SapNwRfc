...
| `DateTime?`, `DateOnly?` | RFCTYPE_DATE                        | Only the day, month and year value is used
| `TimeSpan?`, `TimeOnly?` | RFCTYPE_TIME                        | Only the hour, minute and second value is used
...
| `bool`                   | RFCTYPE_CHAR                        | Char data, fixed length of 1. 'X' is true, anything else is false
